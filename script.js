...
function initializeData() {
    ...
    if (products.length === 0 && categories.length === 0) {
        ...
        products = [
            { id: 'prod-1', name: 'Martillo de Uña', description: 'Un martillo robusto para trabajos de carpintería y construcción.', price: 15.99, imageUrl: 'martilllo.jpg', categoryId: 'cat-1', stock: 50 },
